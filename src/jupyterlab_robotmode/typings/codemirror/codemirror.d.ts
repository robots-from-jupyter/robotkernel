...
declare namespace CodeMirror {
  ...
  interface Editor {
    ...
    on(
      eventName: 'change',
      handler: (instance: CodeMirror.Editor, change: CodeMirror.EditorChange) => void
    ): void;
    off(
      eventName: 'change',
      handler: (instance: CodeMirror.Editor, change: CodeMirror.EditorChange) => void
    ...
    on(
      eventName: 'beforeSelectionChange',
      handler: (instance: CodeMirror.Editor, selection: CodeMirror.Selection) => void
    ): void;
    off(
      eventName: 'beforeSelectionChange',
      handler: (instance: CodeMirror.Editor, selection: CodeMirror.Selection) => void
    ...
    on(
      ...
      handler: (instance: CodeMirror.Editor, line: number, element: HTMLElement) => void
    ): void;
    off(
      eventName: 'renderLine',
      handler: (instance: CodeMirror.Editor, line: number, element: HTMLElement) => void
  ...
  interface Doc {
    ...
    getRange(from: Position, to: CodeMirror.Position, separator?: string): string;
